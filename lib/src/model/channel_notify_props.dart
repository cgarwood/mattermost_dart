...
class _$ChannelNotifyPropsSerializer implements StructuredSerializer<ChannelNotifyProps> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ChannelNotifyProps object,
    ...
    if (object.email != null) {
      result
        ..add(r'email')
        ..add(serializers.serialize(object.email, specifiedType: const FullType(bool)));
    }
    if (object.push != null) {
      result
        ..add(r'push')
        ..add(serializers.serialize(object.push, specifiedType: const FullType(String)));
    }
    if (object.desktop != null) {
      result
        ..add(r'desktop')
        ..add(serializers.serialize(object.desktop, specifiedType: const FullType(String)));
    }
    if (object.markUnread != null) {
      result
        ..add(r'mark_unread')
        ..add(serializers.serialize(object.markUnread, specifiedType: const FullType(String)));
    }
    return result;
  }
