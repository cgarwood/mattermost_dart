...
abstract class Timezone implements Built<Timezone, TimezoneBuilder> {
  ...
  String? get useAutomaticTimezone;
  ...
  Iterable<Object?> serialize(Serializers serializers, Timezone object,
    ...
    if (object.useAutomaticTimezone != null) {
      result
        ...
        ..add(serializers.serialize(object.useAutomaticTimezone, specifiedType: const FullType(bool)));
    }
    if (object.manualTimezone != null) {
      result
        ..add(r'manualTimezone')
        ..add(serializers.serialize(object.manualTimezone, specifiedType: const FullType(String)));
    }
    if (object.automaticTimezone != null) {
      result
        ..add(r'automaticTimezone')
        ..add(serializers.serialize(object.automaticTimezone, specifiedType: const FullType(String)));
    }
    return result;
  }
