...
class _$Timezone extends Timezone {
  ...
  factory _$Timezone([void Function(TimezoneBuilder)? updates]) => (new TimezoneBuilder()..update(updates)).build();

  _$Timezone._({this.useAutomaticTimezone, this.manualTimezone, this.automaticTimezone}) : super._();

  @override
  Timezone rebuild(void Function(TimezoneBuilder) updates) => (toBuilder()..update(updates)).build();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, useAutomaticTimezone.hashCode), manualTimezone.hashCode), automaticTimezone.hashCode));
  }
...
class TimezoneBuilder implements Builder<Timezone, TimezoneBuilder> {
  ...
  String? get useAutomaticTimezone => _$this._useAutomaticTimezone;
  set useAutomaticTimezone(String? useAutomaticTimezone) => _$this._useAutomaticTimezone = useAutomaticTimezone;

  String? _manualTimezone;
  String? get manualTimezone => _$this._manualTimezone;
  set manualTimezone(String? manualTimezone) => _$this._manualTimezone = manualTimezone;

  String? _automaticTimezone;
  String? get automaticTimezone => _$this._automaticTimezone;
  set automaticTimezone(String? automaticTimezone) => _$this._automaticTimezone = automaticTimezone;
