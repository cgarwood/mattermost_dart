...
class _$ChannelNotifyProps extends ChannelNotifyProps {
  ...
  factory _$ChannelNotifyProps([void Function(ChannelNotifyPropsBuilder)? updates]) =>
      (new ChannelNotifyPropsBuilder()..update(updates)).build();

  _$ChannelNotifyProps._({this.email, this.push, this.desktop, this.markUnread}) : super._();

  @override
  ChannelNotifyProps rebuild(void Function(ChannelNotifyPropsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ChannelNotifyPropsBuilder toBuilder() => new ChannelNotifyPropsBuilder()..replace(this);
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc(0, email.hashCode), push.hashCode), desktop.hashCode), markUnread.hashCode));
  }
...
class ChannelNotifyPropsBuilder implements Builder<ChannelNotifyProps, ChannelNotifyPropsBuilder> {
  ...
  _$ChannelNotifyProps build() {
    final _$result =
        _$v ?? new _$ChannelNotifyProps._(email: email, push: push, desktop: desktop, markUnread: markUnread);
    replace(_$result);
    return _$result;
  }
}
