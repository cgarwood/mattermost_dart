...
class ChannelsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ChannelMember] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ChannelMember>> addChannelMember({
    required String channelId,
    required InlineObject53 inlineObject53,
    ...
    final _path = r'/channels/{channel_id}/members'.replaceAll('{' r'channel_id' '}', channelId.toString());
    ...
    try {
      const _type = FullType(InlineObject53);
      _bodyData = _serializers.serialize(inlineObject53, specifiedType: _type);
    ...
    ChannelMember _responseData;

    try {
      const _responseType = FullType(ChannelMember);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> autocompleteChannelsForTeam({
    ...
    final _path = r'/teams/{team_id}/channels/autocomplete'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> autocompleteChannelsForTeamForSearch({
    required String teamId,
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/teams/{team_id}/channels/search_autocomplete'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> channelMembersMinusGroupMembers({
    required String channelId,
    String groupIds = '',
    int? page = 0,
    int? perPage = 0,
    ...
    final _path =
        r'/channels/{channel_id}/members_minus_group_members'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'group_ids': encodeQueryParameter(_serializers, groupIds, const FullType(String)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> createChannel({
    required InlineObject44 inlineObject44,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(InlineObject44);
      _bodyData = _serializers.serialize(inlineObject44, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  ///
  /// Parameters:
  /// * [requestBody] - The two user ids to be in the direct message
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> createDirectChannel({
  ...
  ///
  /// Parameters:
  /// * [requestBody] - User ids to be in the group message channel
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> createGroupChannel({
    required BuiltList<String> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SidebarCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SidebarCategory>> createSidebarCategoryForTeamForUser({
    required String teamId,
    required String userId,
    required SidebarCategory sidebarCategory,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/teams/{team_id}/channels/categories'
        .replaceAll('{' r'team_id' '}', teamId.toString())
    ...
    try {
      const _type = FullType(SidebarCategory);
      _bodyData = _serializers.serialize(sidebarCategory, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
    ...
    SidebarCategory _responseData;

    try {
      const _responseType = FullType(SidebarCategory);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as SidebarCategory;
    ...
    return Response<SidebarCategory>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> deleteChannel({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [notAssociatedToGroup] - Group GUID
  /// * [page]
  /// * [perPage]
  /// * [excludeDefaultChannels] - Whether to exclude default channels (ex Town Square, Off-Topic) from the results.
  /// * [excludePolicyConstrained] - If set to true, channels which are part of a data retention policy will be excluded. The `sysconsole_read_compliance` permission is required to use this parameter. __Minimum server version__: 5.35
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelWithTeamData>>> getAllChannels({
    String? notAssociatedToGroup,
    int? page = 0,
    int? perPage = 0,
    bool? excludeDefaultChannels = false,
    ...
    final _queryParameters = <String, dynamic>{
      if (notAssociatedToGroup != null)
        r'not_associated_to_group': encodeQueryParameter(_serializers, notAssociatedToGroup, const FullType(String)),
      if (page != null) r'page': encodeQueryParameter(_serializers, page, const FullType(int)),
      if (perPage != null) r'per_page': encodeQueryParameter(_serializers, perPage, const FullType(int)),
      if (excludeDefaultChannels != null)
        r'exclude_default_channels': encodeQueryParameter(_serializers, excludeDefaultChannels, const FullType(bool)),
      if (excludePolicyConstrained != null)
        r'exclude_policy_constrained':
            encodeQueryParameter(_serializers, excludePolicyConstrained, const FullType(bool)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> getChannel({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> getChannelByName({
    required String teamId,
    ...
    final _path = r'/teams/{team_id}/channels/name/{channel_name}'
        .replaceAll('{' r'team_id' '}', teamId.toString())
        .replaceAll('{' r'channel_name' '}', channelName.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (includeDeleted != null)
        r'include_deleted': encodeQueryParameter(_serializers, includeDeleted, const FullType(bool)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> getChannelByNameForTeamName({
    ...
    final _path = r'/teams/name/{team_name}/channels/name/{channel_name}'
        .replaceAll('{' r'team_name' '}', teamName.toString())
        .replaceAll('{' r'channel_name' '}', channelName.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [ChannelMember] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ChannelMember>> getChannelMember({
    required String channelId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/channels/{channel_id}/members/{user_id}'
        .replaceAll('{' r'channel_id' '}', channelId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> getChannelMemberCountsByGroup({
    required String channelId,
    ...
    final _path =
        r'/channels/{channel_id}/member_counts_by_group'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (includeTimezones != null)
        r'include_timezones': encodeQueryParameter(_serializers, includeTimezones, const FullType(bool)),
    };
  ...
  /// * [channelId] - Channel GUID
  /// * [page] - The page to select.
  /// * [perPage] - The number of members per page. There is a maximum limit of 200 members.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelMember>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelMember>>> getChannelMembers({
    required String channelId,
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    ...
    BuiltList<ChannelMember> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ChannelMember)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ChannelMember>;
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<ChannelMember>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelMember>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelMember>>> getChannelMembersByIds({
    required String channelId,
    required BuiltList<String> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/channels/{channel_id}/members/ids'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelMember>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelMember>>> getChannelMembersForUser({
    required String userId,
    required String teamId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/users/{user_id}/teams/{team_id}/channels/members'
        .replaceAll('{' r'user_id' '}', userId.toString())
        .replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<String>>> getChannelMembersTimezones({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}/timezones'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelModeration>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelModeration>>> getChannelModerations({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}/moderations'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ChannelModeration> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ChannelModeration)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ChannelModeration>;
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<ChannelModeration>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChannelStats] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ChannelStats>> getChannelStats({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}/stats'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ChannelStats _responseData;

    try {
      const _responseType = FullType(ChannelStats);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ChannelStats;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChannelUnread] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ChannelUnread>> getChannelUnread({
    required String userId,
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/users/{user_id}/channels/{channel_id}/unread'
        .replaceAll('{' r'user_id' '}', userId.toString())
        .replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
    ...
    ChannelUnread _responseData;

    try {
      const _responseType = FullType(ChannelUnread);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ChannelUnread;
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getChannelsForTeamForUser({
    required String userId,
    required String teamId,
    bool? includeDeleted = false,
    int? lastDeleteAt = 0,
    ...
    final _path = r'/users/{user_id}/teams/{team_id}/channels'
        .replaceAll('{' r'user_id' '}', userId.toString())
        .replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (lastDeleteAt != null)
        r'last_delete_at': encodeQueryParameter(_serializers, lastDeleteAt, const FullType(int)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getChannelsForUser({
    required String userId,
    int? lastDeleteAt = 0,
    bool? includeDeleted = false,
    CancelToken? cancelToken,
    ...
    final _path = r'/users/{user_id}/channels'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getDeletedChannelsForTeam({
    required String teamId,
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    ...
    final _path = r'/teams/{team_id}/channels/deleted'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostList>> getPinnedPosts({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}/pinned'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getPrivateChannelsForTeam({
    required String teamId,
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    ...
    final _path = r'/teams/{team_id}/channels/private'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [teamId] - Team GUID
  /// * [requestBody] - List of channel ids
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getPublicChannelsByIdsForTeam({
    required String teamId,
    required BuiltList<String> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/teams/{team_id}/channels/ids'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> getPublicChannelsForTeam({
    required String teamId,
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    ...
    final _path = r'/teams/{team_id}/channels'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<OrderedSidebarCategories>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<OrderedSidebarCategories>>> getSidebarCategoriesForTeamForUser({
    required String teamId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    BuiltList<OrderedSidebarCategories> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(OrderedSidebarCategories)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<OrderedSidebarCategories>;
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<OrderedSidebarCategories>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SidebarCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SidebarCategory>> getSidebarCategoryForTeamForUser({
    required String teamId,
    required String userId,
    ...
    final _path = r'/users/{user_id}/teams/{team_id}/channels/categories/{category_id}'
        .replaceAll('{' r'team_id' '}', teamId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString())
        .replaceAll('{' r'category_id' '}', categoryId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<String>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<String>>> getSidebarCategoryOrderForTeamForUser({
    required String teamId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/users/{user_id}/teams/{team_id}/channels/categories/order'
        .replaceAll('{' r'team_id' '}', teamId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> moveChannel({
    required String channelId,
    required InlineObject50 inlineObject50,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/move'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject50);
      _bodyData = _serializers.serialize(inlineObject50, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> patchChannel({
    required String channelId,
    required InlineObject48 inlineObject48,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/patch'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject48);
      _bodyData = _serializers.serialize(inlineObject48, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelModeration>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelModeration>>> patchChannelModerations({
    required String channelId,
    required ChannelModerationPatch channelModerationPatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/moderations/patch'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ChannelModerationPatch);
      _bodyData = _serializers.serialize(channelModerationPatch, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [SidebarCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SidebarCategory>> removeSidebarCategoryForTeamForUser({
    required String teamId,
    required String userId,
    required String categoryId,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> removeUserFromChannel({
    required String channelId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> restoreChannel({
    required String channelId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/channels/{channel_id}/restore'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2007>> searchAllChannels({
    required InlineObject45 inlineObject45,
    bool? systemConsole = true,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _queryParameters = <String, dynamic>{
      if (systemConsole != null)
        r'system_console': encodeQueryParameter(_serializers, systemConsole, const FullType(bool)),
    };

    dynamic _bodyData;

    try {
      const _type = FullType(InlineObject45);
      _bodyData = _serializers.serialize(inlineObject45, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> searchArchivedChannels({
    required String teamId,
    required InlineObject52 inlineObject52,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/teams/{team_id}/channels/search_archived'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject52);
      _bodyData = _serializers.serialize(inlineObject52, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> searchChannels({
    required String teamId,
    required InlineObject51 inlineObject51,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/teams/{team_id}/channels/search'.replaceAll('{' r'team_id' '}', teamId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject51);
      _bodyData = _serializers.serialize(inlineObject51, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Channel>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Channel>>> searchGroupChannels({
    required InlineObject46 inlineObject46,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/group/search';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject46);
      _bodyData = _serializers.serialize(inlineObject46, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> updateChannel({
    required String channelId,
    required InlineObject47 inlineObject47,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(InlineObject47);
      _bodyData = _serializers.serialize(inlineObject47, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateChannelMemberSchemeRoles({
    required String channelId,
    required String userId,
    required InlineObject55 inlineObject55,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/members/{user_id}/schemeRoles'
        .replaceAll('{' r'channel_id' '}', channelId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
    ...
    try {
      const _type = FullType(InlineObject55);
      _bodyData = _serializers.serialize(inlineObject55, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateChannelNotifyProps({
    required String channelId,
    required String userId,
    required ChannelNotifyProps channelNotifyProps,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/members/{user_id}/notify_props'
        .replaceAll('{' r'channel_id' '}', channelId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
    ...
    try {
      const _type = FullType(ChannelNotifyProps);
      _bodyData = _serializers.serialize(channelNotifyProps, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [Channel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> updateChannelPrivacy({
    required String channelId,
    required InlineObject49 inlineObject49,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/privacy'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject49);
      _bodyData = _serializers.serialize(inlineObject49, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateChannelRoles({
    required String channelId,
    required String userId,
    required InlineObject54 inlineObject54,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/members/{user_id}/roles'
        .replaceAll('{' r'channel_id' '}', channelId.toString())
        .replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
    ...
    try {
      const _type = FullType(InlineObject54);
      _bodyData = _serializers.serialize(inlineObject54, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateChannelScheme({
    required String channelId,
    required InlineObject57 inlineObject57,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/{channel_id}/scheme'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject57);
      _bodyData = _serializers.serialize(inlineObject57, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [SidebarCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SidebarCategory>> updateSidebarCategoriesForTeamForUser({
    required String teamId,
    required String userId,
    required BuiltList<SidebarCategory> sidebarCategory,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(SidebarCategory)]);
      _bodyData = _serializers.serialize(sidebarCategory, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [SidebarCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SidebarCategory>> updateSidebarCategoryForTeamForUser({
    required String teamId,
    required String userId,
    required String categoryId,
    required SidebarCategory sidebarCategory,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<String>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<String>>> updateSidebarCategoryOrderForTeamForUser({
    required String teamId,
    required String userId,
    required BuiltList<String> requestBody,
    CancelToken? cancelToken,
  ...
  ///
  /// Parameters:
  /// * [userId] - User ID to perform the view action for
  /// * [inlineObject56]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2008>> viewChannel({
    required String userId,
    required InlineObject56 inlineObject56,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/channels/members/{user_id}/view'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject56);
      _bodyData = _serializers.serialize(inlineObject56, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
